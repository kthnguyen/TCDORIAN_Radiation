...
out_Tb = np.zeros(shape=(601,1101,1101))
out_lat = np.zeros(shape=(601,1101))
out_lon = np.zeros(shape=(601,1101))
out_time = np.zeros(shape=(601))
...
outdataset.to_netcdf(IRDIR + "\\" + 'Combined_image_new51_theone.nc',mode = 'w', format = "NETCDF4")
