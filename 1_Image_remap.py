...
#for i in range(0,1):
    ...
    lat_inds = t_IRimg_lat[min_lat_inds:min_lat_inds+1101]
    lon_inds = t_IRimg_lon[min_lon_inds:min_lon_inds+1101]
...
# =============================================================================
# #temporary print
# temp_brness = t_IRimg_remap.Tb.values
...
# temp_IRimg_lat = np.round(np.squeeze(t_IRimg_lat),2)
# temp_IRimg_lon = np.round(np.squeeze(t_IRimg_lon),2)
# 
# 
# fig = plt.figure()
# im = plt.imshow(temp_brness, cmap='Greys',origin='lower',animated=True)
